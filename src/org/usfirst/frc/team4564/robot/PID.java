...
/**
 * A class to implement PID control systems.
 * 
...
public class PID {
	 ...
	 * @param forward whether or not to cummulate calculations.  Use true for systems like flywheels where motor power needs to maintain when the target is reached.
	 ...
	 * Used for live tuning of the scalar terms.
	 */
	public void update() {
	...
	/**
	 * Returns the last output calculation.
	 * 
	...
	/**
	 * Calculates a new output value based on an input and a target for the input to reach.
	 * Use this output value on a motor or actuated system where the input changes from the system's motion.
	 * Ex. Target distance, input distance from encoder, use output on the motors associated with the encoder.
	 * 
